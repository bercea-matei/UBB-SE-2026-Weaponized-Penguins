...
public partial class App : Application
{
    ...
    private static IServiceProvider ConfigureServices()
    {
        ...
        string connectionString = @"Data Source = DESKTOP-1JCJMN6\SQLEXPRESS;Database=Communities;Initial Catalog=Communities;Integrated Security=True;Encrypt=False;TrustServerCertificate=True;";
